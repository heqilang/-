window.TILE_VERSION = { ditu: { normal: { version: '088', updateDate: '20220524' }, satellite: { version: '009', updateDate: '20220524' }, normalTraffic: { version: '081', updateDate: '20220524' }, satelliteTraffic: { version: '083', updateDate: '20220524' }, mapJS: { version: '104', updateDate: '20220524' }, satelliteStreet: { version: '083', updateDate: '20220524' }, earthVector: { version: '001', updateDate: '20220524' } }, webapp: { high_normal: { version: '001', updateDate: '20220524' }, lower_normal: { version: '002', updateDate: '20220524' } }, api_for_mobile: { vector: { version: '002', updateDate: '20220524' }, vectorIcon: { version: '002', updateDate: '20220524' } } };
...
(function () {
    ...
    var ka = { cellpadding: 'cellPadding', cellspacing: 'cellSpacing', colspan: 'colSpan', rowspan: 'rowSpan', valign: 'vAlign', usemap: 'useMap', frameborder: 'frameBorder' };
    ...
    B.B0 = function () {
        var a = +new Date(),
            b = H('script', { type: 'text/javascript', async: '' });
        b.charset = 'utf-8';
    ...
    x.extend(La.prototype, {
        ...
        ok: function (a, b, c, d) {
            ...
            if ((c = c && d ? f.Jk(c, this.Sb) : this.dc)) if (((this.dc = new K(c.lng + a * e, c.lat - b * e)), (a = f.rh(this.dc, this.Sb)) && g)) this.re = a;
        },
        Ig: function (a, b) {
            if (Ya(a) && (this.gv(), this.dispatchEvent(new N('onzoomstart')), (a = this.fo(a).zoom), a !== this.Na)) {
                this.Mc = this.Na;
                this.Na = a;
                var c;
        ...
        Ai: function (a) {
            if (a instanceof O || a instanceof K) (a = Za(a, this)), (this.dc = this.Nd.Jk(a, this.Sb)), (this.re = K.GE(a) ? new K(a.lng, a.lat) : this.Nd.rh(this.dc, this.Sb));
        },
        zg: function (a, b) {
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
        ...
        js: function (a) {
            a && $a(a.Ie) && (a.Ie(this), this.dispatchEvent(new N('onaddcontrol', a)));
        },
        WN: function (a) {
            a && $a(a.remove) && (a.remove(), this.dispatchEvent(new N('onremovecontrol', a)));
        },
        Fo: function (a) {
            a && $a(a.ra) && (a.ra(this), this.dispatchEvent(new N('onaddcontextmenu', a)));
        },
        Op: function (a) {
            a && $a(a.remove) && (this.dispatchEvent(new N('onremovecontextmenu', a)), a.remove());
        },
        Ka: function (a) {
            a && $a(a.Ie) && (a.Ie(this), this.dispatchEvent(new N('onaddoverlay', a)));
        },
        Ub: function (a) {
            a && $a(a.remove) && (a.remove(), this.dispatchEvent(new N('onremoveoverlay', a)));
        },
        CK: function () {
        ...
        Xf: function (a) {
            ...
            if (a instanceof O || a instanceof K) (a = new K(Za(a, b).lng, Za(a, b).lat)), b.Ai(a, { noAnimation: o });
                ...
                if (b.xb === Qa) {
                    ...
                    var d = this.bI();
                    d.PF(function (c) {
                        0 === d.Im() && 2 === d.Ga.result.type && (b.Xf(c.Ek(0).point), Qa.Ak(a) && b.JF(a));
                    });
        ...
        Mp: function (a, b) {
            b = b || this.ga();
            if (a && (a instanceof O || a instanceof K)) return (a = Za(a, this)), this.Nd.Mp(a, b, this.dc, this.vb(), this.Sb);
        },
        Rb: function (a, b) {
            b = b || this.ga();
        ...
        k4: function (a, b) {
            var c = map.Sb;
            this.xb === Qa && c && ((a.x += this.offsetX), (a.y += this.offsetY), gb.HK(a, this, b));
        },
        Kd: function (a) {
        ...
        mt: function (a, b) {
            ...
            if (!a || (!a instanceof hb && 0 === a.length) || (a instanceof hb && a.Bj())) return c;
            var d = [];
            a instanceof hb ? (d.push(Za(a.pf(), this)), d.push(Za(a.xe(), this))) : (d = a.slice(0));
            for (var b = b || {}, e = [], f = 0, g = d.length; f < g; f++) e.push(this.Nd.Jk(Za(d[f], this), this.Sb));
            d = new hb();
        ...
        du: function (a) {
            ...
            if (a) {
                ...
                J() && x.da.BF
                    ...
                    : ((this.B.ze = a), this.dispatchEvent(new N('onsetcustomstyles', a)), this.tM(b.B.ze.geotableId));
                var c = { style: a.style };
        ...
        tM: function (a) {
            a ? (this.Bs && this.Bs.Bf === a) || (this.Ah(this.Bs), (this.Bs = new pb({ geotableId: a })), this.$g(this.Bs)) : this.Ah(this.Bs);
        },
        Wb: function () {
    ...
    function Ra(a, b) {
        if (a) {
            ...
            qb ? sb.push({ src: 'product=jsapi&sub_product=jsapi&v=' + B.version + '&sub_product_v=' + B.version + '&t=' + d + '&code=' + a + '&da_src=' + a + c }) : e({ src: 'product=jsapi&sub_product=jsapi&v=' + B.version + '&sub_product_v=' + B.version + '&t=' + d + '&code=' + a + '&da_src=' + a + c });
            tb ||
    ...
    B.nM = {
        ...
        main_domain_cdn: { baidu: ['mapapip0.bdimg.com', 'mapapip1.bdimg.com', 'mapapip2.bdimg.com'], other: ['api.map.baidu.com'], webmap: ['webmap0.bdimg.com'] },
    ...
    B.vY = {
        ...
        main_domain_cdn: { baidu: ['mapapip0.bdimg.com', 'mapapip1.bdimg.com', 'mapapip2.bdimg.com'], webmap: ['webmap0.bdimg.com'] },
        map_click: 'mapclick.map.baidu.com',
        vector_traffic: 'maponline0.bdimg.com'
    };
    B.s0 = { 0: { proto: 'http://', domain: B.vY }, 1: { proto: 'https://', domain: B.nM }, 2: { proto: 'https://', domain: B.nM } };
    ...
    function xb(a) {
        var b = cb();
        b >= a.pA
            ? ($a(a.k.va) && a.k.va(a.k.hc(1)), $a(a.k.finish) && a.k.finish(), 0 < a.$f.length && ((b = a.$f[0]), (b.$f = [].concat(a.$f.slice(1))), b.start()))
    ...
    function Lb(a) {
        ...
        do (c = Kb.indexOf(a.charAt(i++))), (d = Kb.indexOf(a.charAt(i++))), (f = Kb.indexOf(a.charAt(i++))), (g = Kb.indexOf(a.charAt(i++))), (c = (c << 2) | (d >> 4)), (d = ((d & 15) << 4) | (f >> 2)), (e = ((f & 3) << 6) | g), (b += String.fromCharCode(c)), 64 != f && (b += String.fromCharCode(d)), 64 != g && (b += String.fromCharCode(e));
        while (i < a.length);
        return b;
    }
    var N = x.lang.vz;
        ...
        void (function (a, b, c) {
            ...
            if (!D || !D.So) {
                var C = b.all && a.attachEvent,
                    ...
                    G = function (a) {
                        ...
                        if ('define' == a || 'require' == a) {
                            ...
                            'function' == typeof a
                                ? a(G)
                                : ('' + a).replace(/^(?:([\w$_]+)\.)?(\w+)$/, function (a, c, d) {
                                      b[0] = d;
                                      s.apply(G.gG(c), b);
                                  });
                    },
                ...
                w.prototype.set = function (a, b) {
                    if ('string' == typeof a) 'protocolParameter' == a && (b = u({ postUrl: p, protocolParameter: p }, b)), (this.Vs[a] = b);
                ...
                G('init');
                var ca = w.prototype;
                U(ca, { start: ca.start, create: ca.create, send: ca.send, set: ca.set, get: ca.get, on: ca.M, un: ca.cd, fire: ca.Ws });
                var Ma = y();
                ...
                a.onerror = function (a, b, d, e) {
                    ...
                    g && c.alog('exception.send', 'exception', { Mt: a, PE: b, It: d, nm: e });
                    return q;
                };
                c.alog('exception.on', 'catch', function (a) {
                    c.alog('exception.send', 'exception', { Mt: a.Mt, PE: a.path, It: a.It, method: a.method, wL: 'catch' });
                });
            }
        })(a, b, c);
        void (function (a, b, c) {
            ...
            if (s && s.Bh && k() < s.Bh) {
                var C = ['Moz', 'O', 'ms', 'Webkit'],
                    ...
                    Rb = function (a, b) {
                        ...
                        c.src = 'data:image/webp;base64,' + { U3: 'UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA', T3: 'UklGRhoAAABXRUJQVlA4TA0AAAAvAAAAEAcQERGIiP4HAA==', alpha: 'UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAARBxAR/Q9ERP8DAABWUDggGAAAABQBAJ0BKgEAAQAAAP4AAA3AAP7mtQAAAA==', qk: 'UklGRlIAAABXRUJQVlA4WAoAAAASAAAAAAAAAAAAQU5JTQYAAAD/////AABBTk1GJgAAAAAAAAAAAAAAAAAAAGQAAABWUDhMDQAAAC8AAAAQBxAREYiI/gcA' }[a];
                    },
                    wc = function (a, b) {
    ...
    var Vb = [72.6892532, 0.1939743381, 136.1168614, 54.392257],
        ...
        pc = 1e8;
    function qc(a, b, c) {
        for (var d = Xb, e = 0; e < d; e += 2) if (a.lng >= b[e] && a.lng <= b[e + 1] && a.lat >= c[e] && a.lat <= c[e + 1]) return o;
        return q;
    }
    function rc(a) {
        var b = a.lng,
        ...
        for (;;) {
            ...
            if (1.0e-6 > f) {
                a: {
                    ...
                    for (G = 0; G <= c; G++) {
                        for (d = 0; d <= f; d++)
                            if (((C = b(j)), (E = j.lng * pc), (u = j.lat * pc), (l = C.lng * pc), (C = C.lat * pc), !(l < k || C < s || l > m || C > D))) {
                                E -= l;
                                u -= C;
    ...
    function tc(a) {
        var b = {};
        if (a.lng < Vb[0] - 0.4 || a.lat < Vb[1] - 0.4 || a.lng > Vb[2] + 0.4 || a.lat > Vb[3] + 0.4) return (b.lng = a.lng), (b.lat = a.lat), b;
        if (qc(a, cc, dc)) return (b = rc(a));
        for (var b = 0, c = kc, d = 0, e = new yc(), f = 0, d = 0; d < $b; ++d) bc[d] <= a.lat ? bc[(d + 1) % $b] > a.lat && 0 < Bc({ lng: ac[d], lat: bc[d] }, { lng: ac[(d + 1) % $b], lat: bc[(d + 1) % $b] }, a) && ++f : bc[(d + 1) % $b] <= a.lat && 0 > Bc({ lng: ac[d], lat: bc[d] }, { lng: ac[(d + 1) % $b], lat: bc[(d + 1) % $b] }, a) && --f;
        if ((0 === f ? lc : mc) === lc) {
            for (f = 0; f < $b; ++f)
                if (((d = new zc(ac[f], bc[f], ac[(f + 1) % $b], bc[(f + 1) % $b])), (e.wg.lng = d.oy.wg.lng - 0.5), (e.wg.lat = d.oy.wg.lat - 0.5), (e.Eg.lng = d.oy.Eg.lng + 0.5), (e.Eg.lat = d.oy.Eg.lat + 0.5), e.contains(a) !== lc)) {
                    var g;
                    var i = d.pu.lng,
                        k = d.pu.lat,
                        l = d.vx.lng,
                    ...
                    g = m - k;
                    var n = i - l;
                    !(Math.abs(g - 0) > nc) && !(Math.abs(n - 0) > nc) ? (g = d.pu) : ((i = l * k - i * m), (k = n * a.lng - g * a.lat), (l = g * g - n * n), (g = { lng: (n * k - g * i) / l, lat: -(g * k + n * i) / l }));
                    n = 180;
                    i = 90;
                    k = -180;
                    l = -90;
                    ...
                    g.lng <= k && g.lng >= n && g.lng <= l && g.lat >= i ? ((d = a.lat * hc), (n = a.lng * hc), (i = g.lat * hc), (g = g.lng * hc), (k = Math.cos(d) * Math.cos(i)), (d = k * Math.cos(n) * Math.cos(g) + k * Math.sin(n) * Math.sin(g) + Math.sin(d) * Math.sin(i)), -1 > d ? (d = -1) : 1 < d && (d = 1), (d = Math.acos(d) * oc)) : ((g = Ac(a, d.pu)), (d = Ac(a, d.vx)), (d = g < d ? g : d));
                    d < c && (c = d);
                }
            c < kc && (b = (kc - c) / kc);
        } else b = 1;
    ...
    function Ec(a) {
        var b = decodeURIComponent(a.substring(a.indexOf('?') + 1)),
            c = new Date().getTime(),
            d = window.___abvk ? window.___abvk : Fc('SECKEY_ABVK'),
            e = Fc('BMAP_SECKEY'),
            a = a + ('&seckey=' + encodeURIComponent(d + ',' + e) + '&timeStamp=' + c),
            b = (md5 && md5(md5(b + ('&seckey=' + d + ',' + e + '&timeStamp=' + c) + 'F5L2O6R6AD8990O') + 'H0A9P8P7Y6ABQO0')) || '';
    ...
    x.dz = (function () {
        ...
        return {
            ...
            get: function (e) {
                return d && a(e) ? c.getItem(b + e + '_' + Gc[e]) : q;
            },
            yK: a
        };
    })();
    ...
    x.object.extend(L, {
                    ...
                    e.UC == q &&
                        ...
                        setTimeout(function () {
                            for (var a = [], b = 0, c = e.Sd.Nn.length; b < c; b++) {
                                var d = e.Sd.Nn[b],
                                    l = '';
                                ja.dz.yK(d) ? (l = ja.dz.get(d)) : ((l = ''), a.push(d + '_' + Gc[d]));
                            ...
                            if (a.length < 0) {
                                for (let i = 0; i < a.length; i++) {
                                    mf = 'assets/js/bMap/modules' + a[i] + '.js';
                                    oa(mf);
                                }
                            } else {
                                e.XK;
        ...
        EK: function (a) {
            if (a && this.KL()[a]) for (var a = this.KL()[a], b = 0; b < a.length; b++) this.EK(a[b]), this.Sd.Bl[a[b]] || this.TN(a[b]);
        },
        TN: function (a) {
            for (var b = 0; b < this.Sd.Nn.length; b++) if (this.Sd.Nn[b] == a) return;
            this.Sd.Nn.push(a);
        },
        VZ: function (a, b) {
            var c = this.kb(a);
    ...
    for (
        var Hc = (function (a, b) {
                ...
                this,
                '\u5f5f\u66f0\u6c19\u5f5f\u66f0\u5e52\u59c8\u5ef2ll\u5c2b\u5ef2\u59c8k\u5f5f\u6b31\u6b9b\u5e77l\u56c4\u735c\u59c8\u59c8\u706e\u5f5f\u6b31\u7209qt\u5f5f\u6b31\u6b9b\u735a\u5ef2\u72b8\u7313_\u545a\u72b8try\u5f5f\u66f0\u6c19v\u5f5f\u6b31\u6b9b\u6730\u545a\u59c8\u545a\u545a\u5ef2\u6c36\u5ef2\u5ef2\u545a\u59c8\u5ef2\u6730h\u59c8ll\u545a\u706e\u545a\u735cii\u5ef2\u5e77\u59c8\u58a0\u545ah\u5ef2\u6c36\u5f5f\u6a4a\u5f6e\u5f5f\u5f6e\u645a\u5f5f\u62a1\u5e52\u5f5f\u6a4a\u62a1\u5f5f\u6256\u6c19\u5f5f\u62a1\u5fb4\u5f5f\u6a4a\u692d\u5f5f\u5f6e\u7074\u5f5f\u63cb\u6b31\u5f5f\u6a4a\u62a1\u5f5f\u6256\u7209\u5f5f\u63cb\u692d\u5f5f\u6a4a\u72ba\u5f5f\u62a1\u72ba\u5f5f\u6256\u62a1\u5f5f\u6a4a\u6c19\u5f5f\u5f6e\u5f6e\u5f5f\u6256\u7209\u5f5f\u6a4a\u72ba\u5f5f\u5f6e\u645a\u5f5f\u63cb\u5e52\u5f5f\u6a4a\u72ba\u5f5f\u5f6e\u63cb\u5f5f\u63cb\u6a4a\u5f5f\u6a4a\u7074\u5f5f\u63cb\u6b9b\u5f5f\u63cb\u7209\u5f5f\u6a4a\u692d\u5f5f\u5f6e\u7074\u5f5f\u6256\u62a1\u5f5f\u6a4a\u6c19\u5f5f\u5f6e\u6b9b\u5f5f\u62a1\u6b31\u5f5f\u6a4a\u5f6e\u5f5f\u5f6e\u5f6e\u5f5f\u5f6e\u5e52\u6c36i\u5ef2\u5ef2\u6730\u545a\u735cl\u6c36\u5ef2\u59c8\u5ef2\u706e\u545a\u56c4l\u706e\u735c\u5ef2l\u624fl\u545a\u5ef2\u6730ih\u58a0i\u706e\u59c8\u59c8\u735c\u6c36\u545a\u545ah\u624f\u735c\u735c\u59c8\u5e77\u545a\u545a\u5ef2l\u5ef2\u624f\u735c\u56c4\u56c4\u5ef2\u6730hh\u545a\u6730\u545a\u5ef2\u5ef2\u59c8i\u5e77hh\u735c\u545a\u5ef2\u5e77\u56c4\u5ef2\u59c8\u5ef2\u545a\u6c36\u545arr\u7313r\u5e77\u5ef2lh\u5ef2\u5ef2\u6730\u545a\u56c4\u5ef2\u58a0\u5ef2\u6c36l\u5ef2h\u5ef2\u706el\u5ef2\u735clh\u624f\u56c4\u545a\u5ef2\u5ef2\u545a\u5e77\u5ef2ih\u59c8\u5ef2\u5e77\u5f5f\u6b31\u7209qt\u5f5f\u6b31\u6b9b\u735a\u5ef2\u72b8\u7313_\u59c8\u7313u\u72b8t\u5f5f\u66f0\u6c19v\u5f5f\u6b31\u6b9b\u6c36\u5f5f\u66f0\u6c19\u5ef2k\u5f5f\u6b31\u6b9b\u6c36\u5f5f\u66f0\u6c19\u59c8\u7313\u72b8su\u735c\u545a\u5f5f\u6b31\u6b9b\u624f\u5ef2\u58a0l\u545a\u735c\u6730\u545a\u735c\u545a\u56c4i\u706e\u5ef2h\u5ef2\u58a0\u545a\u6c36P\u6256NOR\u6256M\u6256\u6730\u56c4\u58a0h\u6730\u58a0l\u56c4\u5ef2\u5ef2\u624f\u545a\u56c4\u56c4l\u735c\u6c36\u5ef2uth_k\u545ay\u5f5f\u6b31\u6b9b\u6730\u545a\u58a0\u545a\u56c4\u545a\u624fSJv\u6a4aY\u72bah\u6b31\u692dZ\u6b9bh\u72ba\u735aHS\u6730\u735a\u5ef2rs\u545a\u624fh\u5ef2\u545a\u735c\u58a0\u6730\u5ef2\u545ahl\u59c8\u706e\u545al\u545ai\u545a\u6c36h\u56c4\u735c\u545ah\u6730\u5ef2\u545ai\u735ch\u5e77\u58a0\u5ef2\u59c8\u5ef2l\u6c36\u545a\u545ai\u735ci\u6730il\u5ef2\u545a\u56c4\u6c36l\u545a\u735cl\u59c8\u6730\u5a32u\u72b8\u59c8ti\u7313\u72b8'
            ),
            Ic = 233,
            Jc = ++Ic;
        --Jc;
                                    ...
                                    f = setTimeout(function () {
                                        for (
                                            ...
                                            switch (c) {
                                                ...
                                                case b[V('0x1a')]:
                                                    ra(d, function (b) {
                                                        (!b || b[V('0x10')] === j || 0 !== b[a[V('0x1b')]]) &&
                                                            Kc(a[V('0x1c')], function (b) {
                                                                (!b || b[V('0x10')] === j || a.alldi(b[a.emedi], 0)) && Lc(V('0x1d'));
                                                            });
                                                    }),
                                                        (c = V('0x1e'));
                                            }
    ...
    function kb(a, b) {
        a && ((this.Kb = a), (this.ba = 'spot' + kb.ba++), (b = b || {}), (this.Xg = b.text || ''), (this.Mv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5]), (this.NJ = b.userData || p), (this.Uh = b.minZoom || p), (this.Gf = b.maxZoom || p));
    }
    kb.ba = 0;
    ...
    x.lang.ua(Oc, x.lang.Da, 'Control');
    x.extend(Oc.prototype, {
        ...
        qc: function (a) {
            if (this.T1 || !Ya(a) || isNaN(a) || a < Pc || 3 < a) a = this.defaultAnchor;
            this.k = this.k || { Dg: q };
        ...
        getContainer: v('C'),
        Ye: function (a) {
            a instanceof M && ((this.k = this.k || { Dg: q }), (this.k.Aa = new M(a.width, a.height)), this.C && this.qc(this.k.anchor));
        },
        Qf: function () {
            return this.k.Aa;
        },
    ...
    function lb(a) {
        Oc.call(this);
        a = a || {};
        this.k = { Dg: q, UF: a.showZoomInfo || o, anchor: a.anchor, Aa: a.offset, type: a.type, SW: a.enableGeolocation || q };
        this.defaultAnchor = J() ? 3 : Pc;
        this.defaultOffset = new M(10, 10);
        this.qc(a.anchor);
        this.wn(a.type);
        this.Ee();
    }
    x.lang.ua(lb, Oc, 'NavigationControl');
    ...
    function Sc(a) {
        Oc.call(this);
        a = a || {};
        this.k = { anchor: a.anchor || Rc, Aa: a.offset || new M(10, 30), G_: a.showAddressBar !== q, B2: a.enableAutoLocation || q, ZM: a.locationIcon || p };
        var b = this;
        this.Zu = 1200;
        b.u0 = [];
        this.qe = [];
    ...
    x.lang.ua(Sc, Oc, 'GeolocationControl');
    ...
    x.lang.ua(Tc, Oc, 'CopyrightControl');
    ...
    function nb(a) {
        Oc.call(this);
        a = a || {};
        this.k = { Dg: q, size: a.size || new M(150, 150), padding: 5, Va: a.isOpen === o ? o : q, K0: 4, Aa: a.offset, anchor: a.anchor };
    ...
    x.lang.ua(nb, Oc, 'OverviewMapControl');
    ...
    function Uc(a) {
        ...
        this.k = { Dg: q, Aa: a.offset || this.defaultOffset, anchor: a.anchor || this.defaultAnchor, expand: !!a.expand };
    ...
    x.lang.ua(Uc, Oc, 'CityListControl');
    ...
    function mb(a) {
        ...
        this.qc(a.anchor);
        this.ei = { metric: { name: 'metric', GK: 1, sM: 1e3, aP: '\u7c73', bP: '\u516c\u91cc' }, us: { name: 'us', GK: 3.2808, sM: 5280, aP: '\u82f1\u5c3a', bP: '\u82f1\u91cc' } };
        this.ei[this.k.dd] || (this.k.dd = 'metric');
        this.lJ = p;
        this.LI = {};
        this.Ee();
    }
    x.lang.ua(mb, Oc, 'ScaleControl');
    ...
    function ob(a) {
        ...
        this.defaultOffset = new M(10, 10);
        this.k = { Dg: q, qh: [Na, ab, Ta, Qa], uW: ['B_DIMENSIONAL_MAP', 'B_SATELLITE_MAP', 'B_NORMAL_MAP'], type: a.type || Vc, Aa: a.offset || this.defaultOffset, WW: o };
        this.qc(a.anchor);
        '[object Array]' == Object.prototype.toString.call(a.mapTypes) && (this.k.qh = a.mapTypes.slice(0));
        this.Ee();
    }
    x.lang.ua(ob, Oc, 'MapTypeControl');
    ...
    function Xc(a) {
        ...
        this.Wi = q;
        this.lw = p;
        this.VI = new Yc({ of: 'api' });
        this.WI = new Zc(p, { of: 'api' });
        this.defaultAnchor = Qc;
        this.defaultOffset = new M(10, 10);
        this.qc(a.anchor);
        this.Ee();
    ...
    x.lang.ua(Xc, Oc, 'PanoramaControl');
    ...
    x.lang.ua($c, x.lang.Da, 'ContextMenu');
    ...
    var ad = I.pa + 'menu_zoom_in.png',
        bd = I.pa + 'menu_zoom_out.png';
    function cd(a, b, c) {
        if (a && $a(b)) {
            x.lang.Da.call(this);
    ...
    x.lang.ua(cd, x.lang.Da, 'MenuItem');
    ...
    x.object.extend(hb.prototype, {
        ...
        At: function (a) {
            if (!(a instanceof hb) || Math.max(a.Ne, a.Je) < Math.min(this.Ne, this.Je) || Math.min(a.Ne, a.Je) > Math.max(this.Ne, this.Je) || Math.max(a.$d, a.Yd) < Math.min(this.$d, this.Yd) || Math.min(a.$d, a.Yd) > Math.max(this.$d, this.Yd)) return p;
    ...
    function dd() {}
    dd.prototype.jy = function () {
        aa('lngLatToPoint\u65b9\u6cd5\u672a\u5b9e\u73b0');
    };
    dd.prototype.Ej = function () {
    ...
    x.lang.ua(gd, x.lang.Da, 'Overlay');
    gd.Mm = function (a) {
        a *= 1;
        return !a ? 0 : (-1e5 * a) << 1;
    };
    ...
    x.lang.ua(ib, gd, 'OverlayInternal');
    ...
    function id(a) {
        ib.call(this);
        a = a || {};
        this.z = { strokeColor: a.strokeColor || '#3a6bdb', lc: a.strokeWeight || 5, td: a.strokeOpacity || 0.65, strokeStyle: a.strokeStyle || 'solid', qj: a.enableMassClear === q ? q : o, Dk: p, Fm: p, mf: a.enableEditing === o ? o : q, lN: 5, t0: q, jf: a.enableClicking === q ? q : o, ti: a.icons && 0 < a.icons.length ? a.icons : p };
    ...
    id.iF = [0.09, 0.005, 1.0e-4, 1.0e-5];
    ...
    function jd(a) {
        ib.call(this);
        this.V = this.map = p;
        this.z = { width: 0, height: 0, Aa: new M(0, 0), opacity: 1, background: 'transparent', iy: 1, QM: '#000', XY: 'solid', point: p };
        this.kO(a);
        this.point = this.z.point;
    }
    x.lang.ua(jd, ib, 'Division');
    ...
    function ld(a, b) {
        if (a) {
            b = b || {};
            this.style = { anchor: b.anchor || new M(0, 0), fillColor: b.fillColor || '#000', sg: b.fillOpacity || 0, scale: b.scale || 1, rotation: b.rotation || 0, strokeColor: b.strokeColor || '#000', td: b.strokeOpacity || 1, lc: b.strokeWeight };
    ...
    function md(a, b, c, d) {
        a && ((this.Rv = {}), (this.vL = d ? !!d : q), (this.jd = []), (this.U_ = a instanceof ld ? a : p), (this.aJ = b === j ? o : !!(b.indexOf('%') + 1)), (this.gk = isNaN(parseFloat(b)) ? 1 : this.aJ ? parseFloat(b) / 100 : parseFloat(b)), (this.bJ = !!(c.indexOf('%') + 1)), (this.repeat = c != j ? (this.bJ ? parseFloat(c) / 100 : parseFloat(c)) : 0));
    }
    function nd(a, b) {
        x.lang.Da.call(this);
        this.content = a;
    ...
    x.lang.ua(nd, x.lang.Da, 'InfoWindow');
    ...
    La.prototype.Mb = function (a, b) {
        if (a instanceof nd && (b instanceof O || b instanceof K)) {
            var c = this.R;
            c.Wm ? c.Wm.ta(b) : ((c.Wm = new W(b, { icon: new kd(I.pa + 'blank.gif', { width: 1, height: 1 }), offset: new M(0, 0), clickable: q })), (c.Wm.$R = 1));
            this.Ka(c.Wm);
            c.Wm.Mb(a);
        }
    };
    ...
    function od(a, b) {
        ...
        this.V = this.map = p;
        b = b || {};
        this.z = { width: 0, Aa: b.offset || new M(0, 0), fq: { backgroundColor: '#fff', border: '1px solid #f00', padding: '1px', whiteSpace: 'nowrap', font: '12px ' + I.fontFamily, zIndex: '80', MozUserSelect: 'none' }, position: b.position || p, qj: b.enableMassClear === q ? q : o, jf: o };
    ...
    function sd(a, b) {
        if (0 !== arguments.length) {
            ...
            b = b || {};
            this.z = { $a: a, opacity: b.opacity || 1, vp: b.imageURL || '', Hs: b.displayOnMinLevel || 1, qj: b.enableMassClear === q ? q : o, Gs: b.displayOnMaxLevel || 19, O_: b.stretch || q };
    ...
    function wd(a, b) {
        ...
        vd() &&
            ...
            (c.ea = { ha: a }),
            (c.z = { shape: b.shape || td, size: b.size || ud, color: b.color || '#fa937e', qj: o }),
            (this.zB = []),
            (this.qe = []),
    ...
    x.lang.ua(wd, ib, 'PointCollection');
    ...
    var xd = new kd(I.pa + 'marker_red_sprite.png', new M(19, 25), { anchor: new M(10, 25), infoWindowAnchor: new M(10, 0) }),
        yd = new kd(I.pa + 'marker_red_sprite.png', new M(20, 11), { anchor: new M(6, 11), imageOffset: new M(-19, -13) });
    function W(a, b) {
        ib.call(this);
        b = b || {};
        this.point = a;
        this.Gq = this.map = p;
        this.z = { Aa: b.offset || new M(0, 0), yj: b.icon || xd, Uk: yd, title: b.title || '', label: p, qK: b.baseZIndex || 0, jf: o, q5: q, ME: q, qj: b.enableMassClear === q ? q : o, Gb: q, VN: b.raiseOnDrag === o ? o : q, bO: q, Id: b.draggingCursor || I.Id, rotation: b.rotation || 0 };
    ...
    x.extend(W.prototype, {
        Vb: function (a) {
            if (a instanceof kd || a instanceof ld) this.z.yj = a;
        },
        gp: function () {
            return this.z.yj;
        },
        Vy: function (a) {
            a instanceof kd && (this.z.Uk = a);
        },
        getShadow: function () {
            return this.z.Uk;
        },
    ...
    x.lang.ua(zd, id, 'Polygon');
    x.extend(zd.prototype, {
        me: function (a, b) {
            this.Bo = id.Cx(a).slice(0);
            var c = id.Cx(a).slice(0);
            1 < c.length && c.push(new O(c[0].lng, c[0].lat));
            id.prototype.me.call(this, c, b);
        },
        vn: function (a, b) {
    ...
    x.lang.ua(Ad, id, 'Polyline');
    function Bd(a, b, c) {
        this.point = a;
        this.xa = Math.abs(b);
        zd.call(this, [], c);
    }
    Bd.iF = [0.01, 1.0e-4, 1.0e-5, 4.0e-6];
    x.lang.ua(Bd, zd, 'Circle');
    ...
    x.extend(Dd.prototype, {
        ...
        J_: function (a, b, c, d) {
            ...
            k && k.Hb
                ? (yb(k.Hb, b),
                  d && ((d = new S(a[0], a[1])), (f = this.map.B.ze ? this.map.B.ze.style : 'normal'), (d = c.getTilesUrl(d, a[2], f)), (k.loaded = q), Gd(k, d)),
                  k.loaded
                      ? this.zf()
                      : Hd(k, function () {
                            e.zf();
                        ...
                        if (va) {
                            if (sa && ta && ua) {
                                var b = cb(),
                                    c = a.map.vb();
                                setTimeout(function () {
                                    Ra(5030, { load_script_time: ta - sa, load_tiles_time: b - ua, map_width: c.width, map_height: c.height, map_size: c.width * c.height });
                                }, 1e4);
        ...
        Wx: function (a) {
            var b = a.Hb;
            b && (Jd(b), Ab(b) && b.parentNode.removeChild(b));
            delete this.xg[a.name];
            a.loaded || (Jd(b), Fd(a), (a.Hb = p), (a.Cj = p));
        },
        os: function (a, b) {
        ...
        Vf: function (a) {
            ...
            if (b.map.oa() == Qa)
                L.load(
                    'coordtrans',
                    function () {
                        b.map.Sb || ((b.map.Sb = Qa.Ak(b.map.bh)), (b.map.Uw = Qa.GL(b.map.Sb)));
                        b.HI();
                    },
                    o
                );
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (i.Mw) {
                    ...
                    if (this.map.Wb()) {
                        ...
                        continue;
                    } else (k.style.display = 'block'), (this.nd.style.display = 'none'), this.map.dispatchEvent(new N('vectorchanged'), { isvector: q });
                }
                if (!i.uI && !((i.Ap && !this.map.Wb()) || (i.EM && this.map.Wb()))) {
                    ...
                    w = [];
                    for (d.cC = []; n < u; n++) for (y = l; y < e; y++) w.push([n, y]), d.cC.push({ x: n, y: y });
        ...
        Ah: function (a) {
            ...
            if (a instanceof eb) b && a.Rm && (a.remove(), (a.Rm = q));
                ...
                if (a.Ap) for (var b = 0, c = this.Hg.length; b < c; b++) a == this.Hg[b] && this.Hg.splice(b, 1);
                else {
                    b = 0;
    ...
    function Ld(a) {
        ...
        if (a.Cj) {
            ...
            a.Hb && !Ab(a.Hb) && a.NO.Pb && (a.NO.Pb.appendChild(a.Hb), 6 >= x.da.ma && 0 < x.da.ma && a.KJ && (a.Hb.style.cssText += ';filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + a.src + '",sizingMethod=scale);'));
            var d = b.sF - b.IV,
                e;
            for (e in c) {
                if (0 >= d) break;
                if (!b.xg[e]) {
                    c[e].Cj = p;
                    var f = c[e].Hb;
                    f && f.parentNode && (f.parentNode.removeChild(f), Jd(f));
                    f = p;
                    c[e].Hb = p;
                    delete c[e];
                    b.sF--;
    ...
    function Jd(a) {
        if (a) {
            ...
            if (b) {
                d = b.length;
                for (c = 0; c < d; c += 1) (e = b[c].name), 'unknown' !== typeof a[e] && $a(a[e]) && (a[e] = p);
            }
            if ((b = a.children)) {
                d = b.length;
                for (c = 0; c < d; c += 1) Jd(a.children[c]);
            }
        }
    }
    function Gd(a, b) {
    ...
    Ed.TS = 0;
    x.lang.ua(Ed, x.lang.Da, 'TileLayer');
    x.extend(Ed.prototype, {
        ...
        getTilesUrl: function (a, b) {
            if (this.map.oa() !== ab && this.map.oa() !== Ta) var c = this.map.gb.os(a.x, b).nm;
            var d = '';
    ...
    function Md(a, b) {
        ...
        this.k = { SK: b.databoxId, hh: b.geotableId, hn: b.q || '', hz: b.tags || '', filter: b.filter || '', bz: b.sortby || '', P_: b.styleId || '', bm: b.ak || qa, Iw: b.age || 36e5, zIndex: 11, VY: 'VectorCloudLayer', Ik: b.hotspotName || 'vector_md_' + (1e5 * Math.random()).toFixed(0), qV: 'LBS\u4e91\u9ebb\u70b9\u5c42' };
        this.Ap = o;
        Ed.call(this, this.k);
    ...
    Od.prototype = new Ed();
    Od.prototype.ra = function (a, b) {
        Ed.prototype.ra.call(this, a, b);
        this.D = a;
    };
    Od.prototype.Gt = ea(o);
    ...
    var Pd = [B.url.proto + B.url.domain.TILES_YUN_HOST[0] + '/georender/gss', B.url.proto + B.url.domain.TILES_YUN_HOST[1] + '/georender/gss', B.url.proto + B.url.domain.TILES_YUN_HOST[2] + '/georender/gss', B.url.proto + B.url.domain.TILES_YUN_HOST[3] + '/georender/gss'],
        Qd = B.url.proto + B.url.domain.main_domain_nocdn.baidu + '/style/poi/rangestyle',
        Rd = 100;
    function pb(a, b) {
        Ed.call(this);
        var c = this;
        ...
        d && ((this.Gh = new Md(a, b)), (this.Gh.aG = this));
        Jb(a) ? (b = a || {}) : ((c.Yn = a), (b = b || {}));
        b.geotableId && (c.Bf = b.geotableId);
        b.databoxId && (c.Yn = b.databoxId);
        d = B.oc + 'geosearch';
        c.nc = { QN: b.pointDensity || Rd, tY: d + '/detail/', uY: d + '/v2/detail/', Iw: b.age || 36e5, hn: b.q || '', Z_: 'png', D3: [5, 5, 5, 5], UY: { backgroundColor: '#FFFFD5', borderColor: '#808080' }, bm: b.ak || qa, hz: b.tags || '', filter: b.filter || '', bz: b.sortby || '', Ik: b.hotspotName || 'tile_md_' + (1e5 * Math.random()).toFixed(0), jG: o };
    ...
    pb.prototype.getTilesUrl = function (a, b) {
        var c = a.x,
            d = a.y,
            e = this.nc,
            c = Pd[Math.abs(c + d) % Pd.length] + '/image?grids=' + c + '_' + d + '_' + b + '&q=' + e.hn + '&tags=' + e.hz + '&filter=' + e.filter + '&sortby=' + e.bz + '&ak=' + this.nc.bm + '&age=' + e.Iw + '&page_size=' + e.QN + '&format=' + e.Z_;
    ...
    function Sd(a, b, c) {
        this.ff = a;
        this.xr = b instanceof Ed ? [b] : b.slice(0);
        c = c || {};
        this.k = { $_: c.tips || '', SE: '', fc: c.minZoom || 4, Zb: c.maxZoom || 18, C3: c.minZoom || 4, B3: c.maxZoom || 18, Ob: 256, ZF: c.textColor || 'black', ED: c.errorImageUrl || '', $a: new hb(new K(-21364736, -16023552), new K(23855104, 19431424)), Nd: c.projection || new T() };
    ...
    var Td = [B.url.proto + B.url.domain.TILE_BASE_URLS[0], B.url.proto + B.url.domain.TILE_BASE_URLS[1], B.url.proto + B.url.domain.TILE_BASE_URLS[2], B.url.proto + B.url.domain.TILE_BASE_URLS[3]],
        Ud = [B.url.proto + B.url.domain.TILE_ONLINE_URLS[0] + '/tile/', B.url.proto + B.url.domain.TILE_ONLINE_URLS[1] + '/tile/', B.url.proto + B.url.domain.TILE_ONLINE_URLS[2] + '/tile/', B.url.proto + B.url.domain.TILE_ONLINE_URLS[3] + '/tile/'],
        Vd = { dark: 'dl', light: 'll', normal: 'pl' },
        Wd = new Ed();
    Wd.xO = o;
    Wd.getTilesUrl = function (a, b, c) {
        var d = a.x,
            a = a.y,
            e = Ub('normal'),
            f = 1,
            ...
            // return (Ud[Math.abs(d + a) % Ud.length] + '?qt=vtile&x=' + (d + '').replace(/-/gi, 'M') + '&y=' + (a + '').replace(/-/gi, 'M') + '&z=' + b + '&styles=' + c + '&scaler=' + f + (6 == x.da.ma ? '&color_dep=32&colors=50' : '') + '&udt=' + e + '&from=jsapi2_0').replace(/-(\d+)/gi, 'M$1');
            tdir = '/assets/js/bMap/tiles';
        return tdir + '/' + b + '/' + d + '/' + a + '.png';
    };
    var Na = new Sd('\u5730\u56fe', Wd, { tips: '\u663e\u793a\u666e\u901a\u5730\u56fe', maxZoom: 19 }),
        Xd = new Ed();
    Xd.MO = [B.url.proto + B.url.domain.TIlE_PERSPECT_URLS[0] + '/resource/mappic/', B.url.proto + B.url.domain.TIlE_PERSPECT_URLS[1] + '/resource/mappic/', B.url.proto + B.url.domain.TIlE_PERSPECT_URLS[2] + '/resource/mappic/', B.url.proto + B.url.domain.TIlE_PERSPECT_URLS[3] + '/resource/mappic/'];
    ...
    var Qa = new Sd('\u4e09\u7ef4', Xd, { tips: '\u663e\u793a\u4e09\u7ef4\u5730\u56fe', minZoom: 15, maxZoom: 20, textColor: 'white', projection: new jb() });
    Qa.yc = function (a) {
        return Math.pow(2, 20 - a);
    };
    Qa.Ak = function (a) {
    ...
    Yd.getTilesUrl = function (a, b) {
        var c = a.x,
            d = a.y;
        return (Td[Math.abs(c + d) % Td.length] + 'u=x=' + c + ';y=' + d + ';z=' + b + ';v=009;type=sate&fm=46&udt=' + Ub('satellite')).replace(/-(\d+)/gi, 'M$1');
    };
    var ab = new Sd('\u536b\u661f', Yd, { tips: '\u663e\u793a\u536b\u661f\u5f71\u50cf', minZoom: 4, maxZoom: 19, textColor: 'white' }),
        Zd = new Ed({ transparentPng: o });
    Zd.getTilesUrl = function (a, b) {
        var c = a.x,
            d = a.y,
            e = Ub('satelliteStreet');
        return (Ud[Math.abs(c + d) % Ud.length] + '?qt=vtile&x=' + (c + '').replace(/-/gi, 'M') + '&y=' + (d + '').replace(/-/gi, 'M') + '&z=' + b + '&styles=sl' + (6 == x.da.ma ? '&color_dep=32&colors=50' : '') + '&udt=' + e).replace(/-(\d+)/gi, 'M$1');
    };
    var Ta = new Sd('\u6df7\u5408', [Yd, Zd], { tips: '\u663e\u793a\u5e26\u6709\u8857\u9053\u7684\u536b\u661f\u5f71\u50cf', labelText: '\u8def\u7f51', minZoom: 4, maxZoom: 19, textColor: 'white' });
    var $d = 1,
        X = {};
    window.N0 = X;
    function Y(a, b) {
        ...
        this.k = { ja: { Ia: b.ja.panel || p, map: b.ja.map || p, ah: b.ja.autoViewport || o, Zt: b.ja.selectFirstResult, vt: b.ja.highlightMode, Gb: b.ja.enableDragging || q }, yy: b.onSearchComplete || t(), AN: b.onMarkersSet || t(), zN: b.onInfoHtmlSet || t(), CN: b.onResultsHtmlSet || t(), yN: b.onGetBusListComplete || t(), xN: b.onGetBusLineComplete || t(), vN: b.onBusListHtmlSet || t(), uN: b.onBusLineHtmlSet || t(), fF: b.onPolylinesSet || t(), Pp: b.reqFrom || '' };
    ...
    var qe = db.prototype;
    U(qe, { clearResults: qe.Qe, setPageCapacity: qe.Zp, getPageCapacity: qe.qf, gotoPage: qe.Nm, searchNearby: qe.Vp, searchInBounds: qe.mn, search: qe.search, enableFirstResultSelection: qe.zD, disableFirstResultSelection: qe.bD });
    function re(a, b) {
        Y.call(this, a, b);
    }
    x.ua(re, Y, 'BaseRoute');
    x.extend(re.prototype, { Qe: t() });
    function se(a, b) {
        Y.call(this, a, b);
        b = b || {};
        this.gu(b.policy);
    ...
    se.Kn = 100;
    se.KP = [0, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0, 1, 1, 1];
    x.ua(se, re, 'TransitRoute');
    x.extend(se.prototype, {
        ...
        Zp: function (a) {
            ...
            this.k.Nk = 'number' !== typeof a ? se.Kn : 1 <= a && a <= se.Kn ? Math.round(a) : se.Kn;
        },
    ...
    ue.YP = ' \u73af\u5c9b \u65e0\u5c5e\u6027\u9053\u8def \u4e3b\u8def \u9ad8\u901f\u8fde\u63a5\u8def \u4ea4\u53c9\u70b9\u5185\u8def\u6bb5 \u8fde\u63a5\u9053\u8def \u505c\u8f66\u573a\u5185\u90e8\u9053\u8def \u670d\u52a1\u533a\u5185\u90e8\u9053\u8def \u6865 \u6b65\u884c\u8857 \u8f85\u8def \u531d\u9053 \u5168\u5c01\u95ed\u9053\u8def \u672a\u5b9a\u4e49\u4ea4\u901a\u533a\u57df POI\u8fde\u63a5\u8def \u96a7\u9053 \u6b65\u884c\u9053 \u516c\u4ea4\u4e13\u7528\u9053 \u63d0\u524d\u53f3\u8f6c\u9053'.split(' ');
    x.ua(ue, re, 'DWRoute');
    ...
    x.ua(ve, ue, 'DrivingRoute');
    ve.prototype.gu = function (a) {
    ...
    x.lang.ua(xe, x.lang.Da, 'RouteAddr');
    ...
    var Ce = Be.prototype;
    U(Ce, { getPoint: Ce.Gm, getLocation: Ce.Cm });
    function Geolocation(a) {
        a = a || {};
        this.B = { timeout: a.timeout || 1e4, maximumAge: a.maximumAge || 6e5, il: q };
        this.qe = [];
        var b = this;
        L.load('othersearch', function () {
    ...
    Ke.Bv = I.pa + 'iw_plus.gif';
    Ke.ZS = I.pa + 'iw_minus.gif';
    Ke.QU = I.pa + 'stop_icon.png';
    x.ua(Ke, Y);
    ...
    function Le(a) {
        Y.call(this, a);
        a = a || {};
        this.nc = { input: a.input || p, nC: a.baseDom || p, types: a.types || [], yy: a.onSearchComplete || t() };
    ...
    function Pa(a, b) {
        function c() {
            e.k.visible ? ('inter' === e.Le && Va() && e.k.haveBreakId && e.k.indoorExitControl === o ? x.K.show(e.pr) : x.K.U(e.pr), this.Ed && this.k.closeControl && this.Af && this.D && this.D.Ha() === this.C ? x.K.show(e.Af) : x.K.U(e.Af), this.k.forceCloseControl && x.K.show(e.Af)) : (x.K.U(e.Af), x.K.U(e.pr));
        }
        this.C = 'string' == typeof a ? x.$(a) : a;
        this.ba = Me++;
        this.k = { enableScrollWheelZoom: o, panoramaRenderer: Oa() ? 'javascript' : 'flash', swfSrc: B.Sf('main_domain_nocdn', 'res/swf/') + 'APILoader.swf', visible: o, indoorExitControl: o, indoorFloorControl: q, linksControl: o, clickOnRoad: o, navigationControl: o, closeControl: o, indoorSceneSwitchControl: o, albumsControl: q, albumsControlOptions: {}, copyrightControlOptions: {}, forceCloseControl: q, haveBreakId: q };
        var b = b || {},
            d;
        ...
        this.Ug = [];
        this.Ir = [];
        'cvsRender' == this.jk || Oa() ? ((this.ck = 90), (this.ek = -90)) : 'cssRender' == this.jk && ((this.ck = 45), (this.ek = -45));
        this.Mr = q;
        var e = this,
            f = (1e5 * Math.random()).toFixed(0);
        B._rd = B._rd || {};
        B._rd['_cbk' + f] = function (a) {
            if (!a || a.error === j || a.error !== 0) Lc('PANORAMA');
            else {
                this.jk === 'flashRender'
                    ? L.load(
                          'panoramaflash',
    ...
    x.extend(Pa.prototype, {
        ...
        Oc: function (a) {
            a != this.Kc && (a > Ne && (a = Ne), a < Oe && (a = Oe), a != this.Kc && (this.Kc = a), 'cssRender' === this.jk && this.Nc(this.Ea));
        },
        NB: function () {
            if (this.D) for (var a = this.D.Mx(), b = 0; b < a.length; b++) (a[b] instanceof W || a[b] instanceof od) && a[b].point && this.wa.push(a[b]);
        },
        Ry: da('D'),
        fu: function (a) {
            this.Nf = a || 'none';
        ...
        CL: function () {
            var a = B.Sf('baidumap', '?'),
                b = this.Yb();
            if (b) {
                var b = { panotype: this.kt(), heading: this.Fa().heading, pitch: this.Fa().pitch, pid: b, panoid: b, from: 'api' },
                    c;
                for (c in b) a += c + '=' + b[c] + '&';
            }
            return a.slice(0, -1);
    ...
    x.lang.ua(Qe, x.lang.Da, 'PanoramaOverlayBase');
        ...
        Fa: function () {
            ...
            if (a && c)
                if (a.ab(c)) b = this.P.Fa();
                    ...
                    b = {};
                    b.heading = Se(a.lng - c.lng, a.lat - c.lat) || 0;
                    var a = b,
                        c = this.dp(),
                        d = this.co();
    ...
    var Te = Re.prototype;
    U(Te, { setPosition: Te.ta, getPosition: Te.ia, setContent: Te.ad, getContent: Te.Bk, setAltitude: Te.GF, getAltitude: Te.dp, getPov: Te.Fa, show: Te.show, hide: Te.U });
    function Ue(a, b) {
        Qe.call(this);
    ...
    x.lang.ua(Ue, Qe, 'PanoramaMarker');
    x.extend(Ue.prototype, {
        ta: function (a) {
            this.Kb = a;
            this.Mf('position', a);
    ...
    var Ve = Ue.prototype;
    U(Ve, { setPosition: Ve.ta, getPosition: Ve.ia, setTitle: Ve.Dc, getTitle: Ve.np, setAltitude: Ve.GF, getAltitude: Ve.dp, getPanoInfo: Ve.iE, getIcon: Ve.gp, setIcon: Ve.Vb, getPov: Ve.Fa });
    function Se(a, b) {
        var c = 0;
        if (0 !== a && 0 !== b) {
    ...
    function Oa(a) {
        ...
        if (a === q || !window.WebGLRenderingContext) return (We = q);
        if (x.platform.Sm) {
            a = 0;
            try {
    ...
    function Xe() {
        ...
        return -1 < a.indexOf('Chrome') || -1 < a.indexOf('SAMSUNG-GT-I9508') ? o : (Ye = q);
    }
    var Ye;
    function Zc(a, b) {
        this.P = a || p;
        ...
        this.yd = { getPanoramaById: [], getPanoramaByLocation: [], getVisiblePOIs: [], getRecommendPanosById: [], getPanoramaVersions: [], checkPanoSupportByCityCode: [], getPanoramaByPOIId: [], getCopyrightProviders: [] };
    }
    B.bn(function (a) {
        'flashRender' !== a.mr() && new Zc(a, { of: 'api' });
    });
    x.extend(Zc.prototype, {
        ca: function () {
            function a(a) {
                if (a) {
                    if (a.id != b.mw) {
                        b.vO(a.id);
                        b.ea = a;
                        Xe() || b.dispatchEvent(new N('onthumbnail_complete'));
                        ...
                        a.jm ? (b.Fj({ haveBreakId: o }), Va() && b.k.closeControl && x.K.show(b.pr)) : x.K.U(b.pr);
                    }
            ...
            b.addEventListener('iid_changed', function () {
                B.Jw('y');
                c.mg(Zc.jl + 'qt=idata&iid=' + b.KA + '&fn=', function (b) {
    ...
    var Ze = Zc.prototype;
    U(Ze, { getPanoramaById: Ze.kp, getPanoramaByLocation: Ze.tj, getPanoramaByPOIId: Ze.Nx });
    function Yc(a) {
        Ed.call(this);
    ...
    Yc.prototype.getTilesUrl = function (a, b) {
        var c = Yc.SG[(a.x + a.y) % Yc.SG.length] + '?udt=20150114&qt=tile&styles=pl&x=' + a.x + '&y=' + a.y + '&z=' + b;
        x.da.ma && 6 >= x.da.ma && (c += '&color_dep=32');
        var d = Dc(c);
        d ? ((d = Nc(d.path, { yp: q })), (c += '&' + d)) : (c = p);
        return c;
    };
    Yc.prototype.Gt = ea(o);
    $e.Xd = new T();
    function $e() {}
    x.extend($e, {
        HW: function (a, b, c) {
            c = x.lang.Lc(c);
            b = { data: b };
            'position_changed' == a && (b.data = $e.Xd.Ej(new S(b.data.mercatorX, b.data.mercatorY)));
            c.dispatchEvent(new N('on' + a), b);
        }
    });
    var af = $e;
    U(af, { dispatchFlashEvent: af.HW });
    var bf = { MP: 50 };
    bf.Ru = B.Sf('pano')[0];
    bf.Nu = { width: 220, height: 60 };
    x.extend(bf, {
        wp: function (a, b, c, d) {
            if (!b || !c || !c.lngLat || !c.panoInstance) d();
            else {
                this.qo === j && (this.qo = new Zc(p, { of: 'api' }));
                var e = this;
                this.qo.vC(b, function (b) {
                    b
                        ? e.qo.tj(c.lngLat, bf.MP, function (b) {
                              if (b && b.id) {
                                  var f = b.id,
                                      k = b.wh,
                                      b = b.xh,
                                      l = Zc.Xd.zl(c.lngLat),
                                      m = e.AS(l, { x: k, y: b }),
                                      k = e.RL(f, m, 0, bf.Nu.width, bf.Nu.height);
        ...
        RL: function (a, b, c, d, e) {
            var f = bf.Ru + '?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}',
                g = { panoId: a, panoHeading: b || 0, panoPitch: c || 0, width: d, height: e },
                f = f.replace(/\{(.*?)\}/g, function (a, b) {
                    return g[b];
                });
            return (a = Dc(f)) ? ((a = Nc(a.path, { yp: q })), f + ('&' + a)) : p;
        }
    });
    var cf = document,
        df = Math,
        ef = cf.createElement('div').style,
        ff;
    a: {
        for (var gf = ['t', 'webkitT', 'MozT', 'msT', 'OT'], hf, jf = 0, kf = gf.length; jf < kf; jf++)
            if (((hf = gf[jf] + 'ransform'), hf in ef)) {
                ff = gf[jf].substr(0, gf[jf].length - 1);
                break a;
            }
        ff = q;
    }
    var lf = ff ? '-' + ff.toLowerCase() + '-' : '',
        nf = mf('transform'),
        of = mf('transitionProperty'),
        pf = mf('transitionDuration'),
        qf = mf('transformOrigin'),
        rf = mf('transitionTimingFunction'),
        sf = mf('transitionDelay'),
        ze = /android/gi.test(navigator.appVersion),
        tf = /iphone|ipad/gi.test(navigator.appVersion),
        uf = /hp-tablet/gi.test(navigator.appVersion),
        vf = mf('perspective') in ef,
        wf = 'ontouchstart' in window && !uf,
        xf = ff !== q,
        yf = mf('transition') in ef,
        zf = 'onorientationchange' in window ? 'orientationchange' : 'resize',
        Af = wf ? 'touchstart' : 'mousedown',
        Bf = wf ? 'touchmove' : 'mousemove',
        Cf = wf ? 'touchend' : 'mouseup',
        Df = wf ? 'touchcancel' : 'mouseup',
        Ef = ff === q ? q : { '': 'transitionend', webkit: 'webkitTransitionEnd', Moz: 'transitionend', O: 'otransitionend', ms: 'MSTransitionEnd' }[ff],
        Ff =
        ...
        Gf = window.cancelRequestAnimationFrame || window.n5 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout,
        Jf = vf ? ' translateZ(0)' : '';
    function Kf(a, b) {
        var c = this,
            d;
        c.Fn = 'object' == typeof a ? a : cf.getElementById(a);
        ...
        c.x = c.options.x;
        c.y = c.options.y;
        c.options.al = xf && c.options.al;
        c.options.si = c.options.rp && c.options.si;
        c.options.Hi = c.options.Dn && c.options.Hi;
        c.options.zoom = c.options.al && c.options.zoom;
        c.options.Gi = yf && c.options.Gi;
        c.options.zoom && ze && (Jf = '');
        c.Nb.style[of] = c.options.al ? lf + 'transform' : 'top left';
        c.Nb.style[pf] = '0';
        c.Nb.style[qf] = '0 0';
        c.options.Gi && (c.Nb.style[rf] = 'cubic-bezier(0.33,0.66,0.66,1)');
        c.options.al ? (c.Nb.style[nf] = 'translate(' + c.x + 'px,' + c.y + 'px)' + Jf) : (c.Nb.style.cssText += ';position:absolute;top:' + c.y + 'px;left:' + c.x + 'px');
        c.options.Gi && (c.options.KD = o);
        c.refresh();
        c.ca(zf, window);
        c.ca(Af);
        !wf && 'none' != c.options.rP && (c.ca('DOMMouseScroll'), c.ca('mousewheel'));
        c.options.Sw &&
    ...
    Kf.prototype = {
        ...
        Vv: function (a) {
            ...
            this[a + 'Scrollbar']
                ? (this[a + 'ScrollbarWrapper'] ||
                      ...
                      (b.style.cssText += ';pointer-events:none;' + lf + 'transition-property:opacity;' + lf + 'transition-duration:' + (this.options.bX ? '350ms' : '0') + ';overflow:hidden;opacity:' + (this.options.Vx ? '0' : '1')),
                      this.Fn.appendChild(b),
                      (this[a + 'ScrollbarWrapper'] = b),
                      (b = cf.createElement('div')),
                      this.options.DF || (b.style.cssText = 'position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);' + lf + 'background-clip:padding-box;' + lf + 'box-sizing:border-box;' + ('h' == a ? 'height:100%' : 'width:100%') + ';' + lf + 'border-radius:3px;border-radius:3px'),
                      (b.style.cssText += ';pointer-events:none;' + lf + 'transition-property:' + lf + 'transform;' + lf + 'transition-timing-function:cubic-bezier(0.33,0.66,0.66,1);' + lf + 'transition-duration:0;' + lf + 'transform: translate(0,0)' + Jf),
                      this.options.Gi && (b.style.cssText += ';' + lf + 'transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)'),
                      this[a + 'ScrollbarWrapper'].appendChild(b),
                      (this[a + 'ScrollbarIndicator'] = b)),
                  'h' == a ? ((this.gM = this.hM.clientWidth), (this.qY = df.max(df.round((this.gM * this.gM) / this.Py), 8)), (this.pY.style.width = this.qY + 'px')) : ((this.iP = this.jP.clientHeight), (this.x0 = df.max(df.round((this.iP * this.iP) / this.Up), 8)), (this.w0.style.height = this.x0 + 'px')),
                  this.HB(a, o))
                : this[a + 'ScrollbarWrapper'] && (xf && (this[a + 'ScrollbarIndicator'].style[nf] = ''), this[a + 'ScrollbarWrapper'].parentNode.removeChild(this[a + 'ScrollbarWrapper']), (this[a + 'ScrollbarWrapper'] = p), (this[a + 'ScrollbarIndicator'] = p));
        },
        GB: function () {
            var a = this;
            setTimeout(
        ...
        Lr: function (a, b) {
            this.dl || ((a = this.rp ? a : 0), (b = this.Dn ? b : 0), this.options.al ? (this.Nb.style[nf] = 'translate(' + a + 'px,' + b + 'px) scale(' + this.scale + ')' + Jf) : ((a = df.round(a)), (b = df.round(b)), (this.Nb.style.left = a + 'px'), (this.Nb.style.top = b + 'px')), (this.x = a), (this.y = b), this.HB('h'), this.HB('v'));
        },
        HB: function (a, b) {
            var c = 'h' == a ? this.x : this.y;
            this[a + 'Scrollbar'] && ((c *= this[a + 'ScrollbarProp']), 0 > c ? (this.options.KD || ((c = this[a + 'ScrollbarIndicatorSize'] + df.round(3 * c)), 8 > c && (c = 8), (this[a + 'ScrollbarIndicator'].style['h' == a ? 'width' : 'height'] = c + 'px')), (c = 0)) : c > this[a + 'ScrollbarMaxScroll'] && (this.options.KD ? (c = this[a + 'ScrollbarMaxScroll']) : ((c = this[a + 'ScrollbarIndicatorSize'] - df.round(3 * (c - this[a + 'ScrollbarMaxScroll']))), 8 > c && (c = 8), (this[a + 'ScrollbarIndicator'].style['h' == a ? 'width' : 'height'] = c + 'px'), (c = this[a + 'ScrollbarMaxScroll'] + (this[a + 'ScrollbarIndicatorSize'] - c)))), (this[a + 'ScrollbarWrapper'].style[sf] = '0'), (this[a + 'ScrollbarWrapper'].style.opacity = b && this.options.Vx ? '0' : '1'), (this[a + 'ScrollbarIndicator'].style[nf] = 'translate(' + ('h' == a ? c + 'px,0)' : '0,' + c + 'px)') + Jf));
        },
        aR: function (a) {
        ...
        ew: function (a) {
            ...
            if (this.enabled) {
                ...
                this.options.zoom && wf && 1 < a.touches.length && ((d = df.abs(a.touches[0].pageX - a.touches[1].pageX)), (c = df.abs(a.touches[0].pageY - a.touches[1].pageY)), (this.e0 = df.sqrt(d * d + c * c)), (this.zy = df.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.nG) / 2 - this.x), (this.Ay = df.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.oG) / 2 - this.y), this.options.Jp && this.options.Jp.call(this, a));
                if (
                    this.options.py &&
                    (this.options.al
                        ? ((c = getComputedStyle(this.Nb, p)
                          ...
                          (d = +(c[12] || c[4])),
                          (c = +(c[13] || c[5])))
                        : ((d = +getComputedStyle(this.Nb, p).left.replace(/[^0-9-]/g, '')), (c = +getComputedStyle(this.Nb, p).top.replace(/[^0-9-]/g, ''))),
                    d != this.x || c != this.y)
                )
                    this.options.Gi ? this.ae(Ef) : Gf(this.mC), (this.Gj = []), this.Lr(d, c), this.options.xy && this.options.xy.call(this);
                this.zw = this.x;
                this.Aw = this.y;
                this.su = this.x;
                this.tu = this.y;
        ...
        xT: function (a) {
            ...
            if (this.options.zoom && wf && 1 < a.touches.length) (e = df.abs(a.touches[0].pageX - a.touches[1].pageX)), (f = df.abs(a.touches[0].pageY - a.touches[1].pageY)), (this.d0 = df.sqrt(e * e + f * f)), (this.dl = o), (b = (1 / this.e0) * this.d0 * this.scale), b < this.options.cl ? (b = 0.5 * this.options.cl * Math.pow(2, b / this.options.cl)) : b > this.options.kq && (b = 2 * this.options.kq * Math.pow(0.5, this.options.kq / b)), (this.Dp = b / this.scale), (e = this.zy - this.zy * this.Dp + this.x), (f = this.Ay - this.Ay * this.Dp + this.y), (this.Nb.style[nf] = 'translate(' + e + 'px,' + f + 'px) scale(' + b + ')' + Jf), this.options.GN && this.options.GN.call(this, a);
            else {
                this.wh = b.pageX;
                this.xh = b.pageY;
                ...
                this.dD += c;
                this.eD += d;
                this.xw = df.abs(this.dD);
                this.yw = df.abs(this.eD);
        ...
        pv: function (a) {
            if (!(wf && 0 !== a.touches.length)) {
                var b = this,
                    c = wf ? a.changedTouches[0] : a,
                    d,
                    e,
                    f = { Ca: 0, time: 0 },
                    g = { Ca: 0, time: 0 },
                ...
                if (b.dl) (d = b.scale * b.Dp), (d = Math.max(b.options.cl, d)), (d = Math.min(b.options.kq, d)), (b.Dp = d / b.scale), (b.scale = d), (b.x = b.zy - b.zy * b.Dp + b.x), (b.y = b.Ay - b.Ay * b.Dp + b.y), (b.Nb.style[pf] = '200ms'), (b.Nb.style[nf] = 'translate(' + b.x + 'px,' + b.y + 'px) scale(' + b.scale + ')' + Jf), (b.dl = q), b.refresh(), b.options.Ip && b.options.Ip.call(b, a);
                else {
                    if (b.th) {
                        ...
                        f.Ca || g.Ca ? ((c = df.max(df.max(f.time, g.time), 10)), b.options.ou && ((f = d - b.zw), (g = e - b.Aw), df.abs(f) < b.options.az && df.abs(g) < b.options.az ? b.scrollTo(b.zw, b.Aw, 200) : ((f = b.AJ(d, e)), (d = f.x), (e = f.y), (c = df.max(f.time, c)))), b.scrollTo(df.round(d), df.round(e), c)) : b.options.ou ? ((f = d - b.zw), (g = e - b.Aw), df.abs(f) < b.options.az && df.abs(g) < b.options.az ? b.scrollTo(b.zw, b.Aw, 200) : ((f = b.AJ(b.x, b.y)), (f.x != b.x || f.y != b.y) && b.scrollTo(f.x, f.y, f.time))) : b.so(200);
                    } else {
                        if (wf)
                            if (b.ZK && b.options.zoom)
                                ...
                                'select' != e && 'input' != e && 'textarea' != e ? ((e = cf.createEvent('MouseEvents')), e.initMouseEvent('click', o, o, a.view, 1, c.screenX, c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, 0, p), (e.WR = o), d.dispatchEvent(e)) : d.focus();
                            }
                        b.so(400);
                    }
        ...
        so: function (a) {
            ...
            if (b == this.x && c == this.y) {
                if ((this.th && ((this.th = q), this.options.xy && this.options.xy.call(this)), this.si && this.options.Vx && ('webkit' == ff && (this.hM.style[sf] = '300ms'), (this.hM.style.opacity = '0')), this.Hi && this.options.Vx)) 'webkit' == ff && (this.jP.style[sf] = '300ms'), (this.jP.style.opacity = '0');
        ...
        bV: function (a) {
            ...
            if ('zoom' == b.options.rP) {
                if (((d = b.scale * Math.pow(2, (1 / 3) * (d ? d / Math.abs(d) : 0))), d < b.options.cl && (d = b.options.cl), d > b.options.kq && (d = b.options.kq), d != b.scale))
        ...
        YU: function (a) {
            a.target == this.Nb && (this.ae(Ef), this.TB());
        },
        TB: function () {
            var a = this,
                b = a.x,
            ...
            a.em ||
                (a.Gj.length
                    ? ((e = a.Gj.shift()), e.x == b && e.y == c && (e.time = 0), (a.em = o), (a.th = o), a.options.Gi)
                        ? (a.JJ(e.time), a.Lr(e.x, e.y), (a.em = q), e.time ? a.ca(Ef) : a.so(0))
                        : ((g = function () {
                              var i = Date.now(),
                                  k;
                              if (i >= d + e.time) {
        ...
        JJ: function (a) {
            a += 'ms';
            this.Nb.style[pf] = a;
            this.si && (this.pY.style[pf] = a);
            this.Hi && (this.w0.style[pf] = a);
        },
        GI: function (a, b, c, d, e) {
            var b = df.abs(a) / b,
                f = (b * b) / 0.0012;
            0 < a && f > c ? ((c += e / (6 / (6.0e-4 * (f / b)))), (b = (b * c) / f), (f = c)) : 0 > a && f > d && ((d += e / (6 / (6.0e-4 * (f / b)))), (b = (b * d) / f), (f = d));
            return { Ca: f * (0 > a ? -1 : 1), time: df.round(b / 6.0e-4) };
        },
        gk: function (a) {
        ...
        AJ: function (a, b) {
            ...
            a = this.Ve[e];
            d = (d = df.abs(a - this.Ve[this.PC])) ? 500 * (df.abs(this.x - a) / d) : 0;
            this.PC = e;
            e = this.vf.length - 1;
            for (c = 0; c < e; c++)
                if (b >= this.vf[c]) {
            ...
            b = this.vf[e];
            c = (c = df.abs(b - this.vf[this.QC])) ? 500 * (df.abs(this.y - b) / c) : 0;
            this.QC = e;
            e = df.round(df.max(d, c)) || 200;
        ...
        refresh: function () {
            ...
            this.Py = df.round(this.Nb.offsetWidth * this.scale);
            this.Up = df.round((this.Nb.offsetHeight + this.sf) * this.scale);
            ...
            this.Vv('h');
            this.Vv('v');
            this.dl || ((this.Nb.style[pf] = '0'), this.so(400));
        },
        scrollTo: function (a, b, c, d) {
            ...
            a = 0;
            for (b = e.length; a < b; a++) e[a].JZ && ((e[a].x = this.x - e[a].x), (e[a].y = this.y - e[a].y)), this.Gj.push({ x: e[a].x, y: e[a].y, time: e[a].time || 0 });
            this.TB();
        },
        disable: function () {
            this.stop();
        ...
        stop: function () {
            this.options.Gi ? this.ae(Ef) : Gf(this.mC);
            this.Gj = [];
            this.em = this.th = q;
        },
        zoom: function (a, b, c, d) {
            var e = c / this.scale;
            this.options.al && ((this.dl = o), (d = d === j ? 200 : d), (a = a - this.nG - this.x), (b = b - this.oG - this.y), (this.x = a - a * e + this.x), (this.y = b - b * e + this.y), (this.scale = c), this.refresh(), (this.x = 0 < this.x ? 0 : this.x < this.ke ? this.ke : this.x), (this.y = this.y > this.sf ? this.sf : this.y < this.qd ? this.qd : this.y), (this.Nb.style[pf] = d + 'ms'), (this.Nb.style[nf] = 'translate(' + this.x + 'px,' + this.y + 'px) scale(' + c + ')' + Jf), (this.dl = q));
        }
    };
    function mf(a) {
        if ('' === ff) return a;
    ...
    ef = p;
    function Lf(a) {
        this.k = { anchor: Rc, offset: new M(0, 0), maxWidth: '100%', imageHeight: 80 };
        var a = a || {},
            b;
        for (b in a) this.k[b] = a[b];
        this.Rl = new Zc(p, { of: 'api' });
        this.hk = [];
        this.P = p;
        this.fg = { height: this.k.imageHeight, width: this.k.imageHeight * Mf };
        this.Pc = this.IB = this.jm = this.Xc = p;
    }
    var Nf = [0, 1, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 4, 5, 5, 5, 6, 6, 7, 8, 8, 8, 9, 10],
        Of = '\u5176\u4ed6 \u6b63\u95e8 \u623f\u578b \u8bbe\u65bd \u6b63\u95e8 \u9910\u996e\u8bbe\u65bd \u5176\u4ed6\u8bbe\u65bd \u6b63\u95e8 \u8bbe\u65bd \u89c2\u5f71\u5385 \u5176\u4ed6\u8bbe\u65bd'.split(' ');
    B.bn(function (a) {
        var b = p;
        a.addEventListener('position_changed', function () {
            a.k.visible && a.k.albumsControl === o && (b ? b.Jy(a.Yb()) : ((b = new Lf(a.k.albumsControlOptions)), b.ra(a)));
        });
        a.addEventListener('albums_visible_changed', function () {
            a.k.albumsControl === o ? (b ? b.Jy(a.Yb()) : ((b = new Lf(a.k.albumsControlOptions)), b.ra(a)), b.show()) : b.U();
        });
    ...
    x.extend(Lf.prototype, {
        ...
        XH: function (a) {
            for (var b = this.hk, c = b.length - 1; 0 <= c; c--) if (b[c].panoId == a) return c;
            return -1;
        },
        Jy: function (a, b) {
            if (b || !this.hk[this.Xc] || !(this.hk[this.Xc].panoId == a && 3 !== this.hk[this.Xc].recoType)) {
                ...
                !b && -1 !== d && this.hk[d] && 3 !== this.hk[d].recoType
                    ? this.Yp(d)
                    : this.WX(function (a) {
                          for (var b = {}, d, i, k = q, l = [], m = 0, n = a.length; m < n; m++) (d = a[m].catlog), (i = a[m].floor), j !== d && ('' === d && j !== i ? ((k = o), b[i] || (b[i] = []), b[i].push(a[m])) : (b[Nf[d]] || (b[Nf[d]] = []), b[Nf[d]].push(a[m])));
                          for (var s in b) k ? l.push({ data: s + 'F', index: s }) : l.push({ data: Of[s], index: s });
                          c.nH = b;
                          c.Ti = l;
                          c.Nl(a);
        ...
        oW: function () {
            if (!this.Qi) {
                ...
                new Kf(a, { Mo: q, py: o, si: q, Hi: q, Dn: q, WE: o, Sw: o, Sx: o });
        ...
        Nl: function (a) {
            this.hk = a;
            this.k.showCatalog && (0 < this.Ti.length ? (Va() ? this.lW() : this.oW(), (this.Pc.offsetLeft = 60)) : (this.Us && (this.C.removeChild(this.Us), (this.Us = p), (this.Pc.gg.style.left = '0px')), this.Qi && (this.C.removeChild(this.Qi), (this.Qi = p)), (this.Pc.offsetLeft = 0)));
            var b = this.EX(a);
            Va() && this.Ti && 0 < this.Ti.length && this.k.showExit && this.qA && ((this.Pc.offsetLeft += this.fg.width + 8), this.Us ? (this.Us.innerHTML = this.qA) : this.mW());
            this.$h.innerHTML = b;
        ...
        qc: function (a) {
            if (!Ya(a) || isNaN(a) || a < Pc || 3 < a) a = this.defaultAnchor;
            var b = this.C,
        ...
        EY: function () {
            this.Pc = J() ? new Kf(this.mk, { Mo: q, py: o, si: q, Hi: q, Dn: q, WE: o, Sw: o, Sx: o }) : new Pf(this.mk);
        },
        U: function () {
    ...
    B.GeolocationControl = Sc;
    B.OverviewMapControl = nb;
    B.CopyrightControl = Tc;
    B.ScaleControl = mb;
    B.MapTypeControl = ob;
    B.CityListControl = Uc;
    B.PanoramaControl = Xc;
    B.TrafficLayer = Od;
    B.CustomLayer = pb;
    B.ContextMenu = $c;
    B.MenuItem = cd;
    ...
    B.BusLineSearch = Ke;
    B.Boundary = Ee;
    B.VectorCloudLayer = Md;
    B.VectorTrafficLayer = Nd;
    B.Panorama = Pa;
    B.PanoramaLabel = Re;
    B.PanoramaService = Zc;
    B.PanoramaCoverageLayer = Yc;
    B.PanoramaFlashInterface = $e;
    function U(a, b) {
    ...
    U(Qf, {
        ...
        panBy: Qf.zg,
        setCenter: Qf.Xf,
        setCurrentCity: Qf.JF,
        setMapType: Qf.Fg,
        setViewport: Qf.Dh,
        setZoom: Qf.Oc,
        highResolutionEnabled: Qf.Xx,
        zoomTo: Qf.Ig,
        zoomIn: Qf.pG,
        zoomOut: Qf.qG,
        addHotspot: Qf.Ew,
        ...
        removeControl: Qf.WN,
        getContainer: Qf.Ha,
        addContextMenu: Qf.Fo,
        removeContextMenu: Qf.Op,
        addOverlay: Qf.Ka,
        removeOverlay: Qf.Ub,
        clearOverlays: Qf.CK,
        openInfoWindow: Qf.Mb,
        closeInfoWindow: Qf.Wc,
        pointToOverlayPixel: Qf.We,
        overlayPixelToPoint: Qf.IN,
        getInfoWindow: Qf.lh,
        getOverlays: Qf.Mx,
        getPanes: function () {
            return { floatPane: this.Zd.LD, markerMouseTarget: this.Zd.ZE, floatShadow: this.Zd.xL, labelPane: this.Zd.RE, markerPane: this.Zd.cN, markerShadow: this.Zd.dN, mapPane: this.Zd.Jt, vertexPane: this.Zd.nP };
        },
        addTileLayer: Qf.$g,
        removeTileLayer: Qf.Ah,
        pixelToPoint: Qf.Ag,
        pointToPixel: Qf.Mp,
        setFeatureStyle: Qf.Xp,
        selectBaseElement: Qf.F4,
        setMapStyle: Qf.du,
        enable3DBuilding: Qf.Xo,
        disable3DBuilding: Qf.DW,
        getPanorama: Qf.Em,
        setBrowserContextmenu: Qf.k_
    });
    var Rf = Sd.prototype;
    U(Rf, { getTileLayer: Rf.gY, getMinZoom: Rf.hp, getMaxZoom: Rf.Dm, getProjection: Rf.Hm, getTextColor: Rf.Km, getTips: Rf.lt });
    U(window, { BMAP_NORMAL_MAP: Na, BMAP_PERSPECTIVE_MAP: Qa, BMAP_SATELLITE_MAP: ab, BMAP_HYBRID_MAP: Ta });
    var Sf = T.prototype;
    U(Sf, { lngLatToPoint: Sf.jy, pointToLngLat: Sf.Ej });
    var Tf = jb.prototype;
    U(Tf, { lngLatToPoint: Tf.jy, pointToLngLat: Tf.Ej });
    var Uf = hb.prototype;
    U(Uf, { equals: Uf.ab, containsPoint: Uf.Zw, containsBounds: Uf.cW, intersects: Uf.At, extend: Uf.extend, getCenter: Uf.pc, isEmpty: Uf.Bj, getSouthWest: Uf.xe, getNorthEast: Uf.pf, toSpan: Uf.dG });
    var Vf = gd.prototype;
    U(Vf, { isVisible: Vf.oh, show: Vf.show, hide: Vf.U });
    gd.getZIndex = gd.Mm;
    var Wf = ib.prototype;
    U(Wf, { openInfoWindow: Wf.Mb, closeInfoWindow: Wf.Wc, enableMassClear: Wf.qj, disableMassClear: Wf.FW, show: Wf.show, hide: Wf.U, getMap: Wf.Hx, addContextMenu: Wf.Fo, removeContextMenu: Wf.Op });
    var Xf = W.prototype;
    U(Xf, { setIcon: Xf.Vb, getIcon: Xf.gp, setPosition: Xf.ta, getPosition: Xf.ia, setOffset: Xf.Ye, getOffset: Xf.Qf, getLabel: Xf.dE, setLabel: Xf.qn, setTitle: Xf.Dc, setTop: Xf.Ei, enableDragging: Xf.Gb, disableDragging: Xf.aD, setZIndex: Xf.iu, getMap: Xf.Hx, setAnimation: Xf.nn, setShadow: Xf.Vy, hide: Xf.U, setRotation: Xf.Ty, getRotation: Xf.VL });
    U(window, { BMAP_ANIMATION_DROP: 1, BMAP_ANIMATION_BOUNCE: 2 });
    var Yf = od.prototype;
    U(Yf, { setStyle: Yf.bd, setStyles: Yf.Di, setContent: Yf.ad, setPosition: Yf.ta, getPosition: Yf.ia, setOffset: Yf.Ye, getOffset: Yf.Qf, setTitle: Yf.Dc, setZIndex: Yf.iu, getMap: Yf.Hx, getContent: Yf.Bk });
    var Zf = kd.prototype;
    U(Zf, { setImageUrl: Zf.lO, setSize: Zf.Ce, setAnchor: Zf.qc, setImageOffset: Zf.cu, setImageSize: Zf.q_, setInfoWindowAnchor: Zf.t_, setPrintImageUrl: Zf.D_ });
    var $f = nd.prototype;
    U($f, { redraw: $f.le, setTitle: $f.Dc, setContent: $f.ad, getContent: $f.Bk, getPosition: $f.ia, enableMaximize: $f.fh, disableMaximize: $f.ox, isOpen: $f.Va, setMaxContent: $f.eu, maximize: $f.ny, enableAutoPan: $f.Rs });
    var ag = id.prototype;
    U(ag, { getPath: ag.ve, setPath: ag.me, setPositionAt: ag.vn, getStrokeColor: ag.bY, setStrokeWeight: ag.bq, getStrokeWeight: ag.YL, setStrokeOpacity: ag.$p, getStrokeOpacity: ag.cY, setFillOpacity: ag.bu, getFillOpacity: ag.zX, setStrokeStyle: ag.aq, getStrokeStyle: ag.XL, getFillColor: ag.yX, getBounds: ag.Kd, enableEditing: ag.mf, disableEditing: ag.EW, getEditing: ag.vX });
    var cg = Bd.prototype;
    U(cg, { setCenter: cg.Xf, getCenter: cg.pc, getRadius: cg.TL, setRadius: cg.wf });
    var dg = zd.prototype;
    U(dg, { getPath: dg.ve, setPath: dg.me, setPositionAt: dg.vn });
    var eg = kb.prototype;
    U(eg, { getPosition: eg.ia, setPosition: eg.ta, getText: eg.nE, setText: eg.hu });
    O.prototype.equals = O.prototype.ab;
    S.prototype.equals = S.prototype.ab;
    M.prototype.equals = M.prototype.ab;
    U(window, { BMAP_ANCHOR_TOP_LEFT: Pc, BMAP_ANCHOR_TOP_RIGHT: Qc, BMAP_ANCHOR_BOTTOM_LEFT: Rc, BMAP_ANCHOR_BOTTOM_RIGHT: 3 });
    var fg = Oc.prototype;
    U(fg, { setAnchor: fg.qc, getAnchor: fg.RD, setOffset: fg.Ye, getOffset: fg.Qf, show: fg.show, hide: fg.U, isVisible: fg.oh, toString: fg.toString });
    var gg = lb.prototype;
    U(gg, { getType: gg.pp, setType: gg.wn });
    ...
    var hg = nb.prototype;
    U(hg, { changeView: hg.se, setSize: hg.Ce, getSize: hg.vb });
    var ig = mb.prototype;
    U(ig, { getUnit: ig.kY, setUnit: ig.RF });
    U(window, { BMAP_UNIT_METRIC: 'metric', BMAP_UNIT_IMPERIAL: 'us' });
    var jg = Tc.prototype;
    U(jg, { addCopyright: jg.Dw, removeCopyright: jg.uF, getCopyright: jg.Am, getCopyrightCollection: jg.YD });
    U(window, { BMAP_MAPTYPE_CONTROL_HORIZONTAL: Vc, BMAP_MAPTYPE_CONTROL_DROPDOWN: 1, BMAP_MAPTYPE_CONTROL_MAP: 2 });
    var kg = Ed.prototype;
    U(kg, { getMapType: kg.oa, getCopyright: kg.Am, isTransparentPng: kg.Gt });
    var lg = $c.prototype;
    U(lg, { addItem: lg.Fw, addSeparator: lg.iC, removeSeparator: lg.wF });
    var mg = cd.prototype;
    U(mg, { setText: mg.hu });
    var ng = Y.prototype;
    U(ng, { getStatus: ng.Im, setSearchCompleteCallback: ng.PF, getPageCapacity: ng.qf, setPageCapacity: ng.Zp, setLocation: ng.tn, disableFirstResultSelection: ng.bD, enableFirstResultSelection: ng.zD, gotoPage: ng.Nm, searchNearby: ng.Vp, searchInBounds: ng.mn, search: ng.search });
    ...
    var og = re.prototype;
    U(og, { clearResults: og.Qe });
    te = se.prototype;
    U(te, { setPolicy: te.gu, toString: te.toString, setPageCapacity: te.Zp });
    U(window, { BMAP_DRIVING_POLICY_LEAST_TIME: 0, BMAP_DRIVING_POLICY_LEAST_DISTANCE: 1, BMAP_DRIVING_POLICY_AVOID_HIGHWAYS: 2 });
    U(window, { BMAP_MODE_DRIVING: 'driving', BMAP_MODE_TRANSIT: 'transit', BMAP_MODE_WALKING: 'walking', BMAP_MODE_NAVIGATION: 'navigation' });
    var pg = Ae.prototype;
    U(pg, { routeCall: pg.gO });
    U(window, { BMAP_HIGHLIGHT_STEP: 1, BMAP_HIGHLIGHT_ROUTE: 2 });
    U(window, { BMAP_ROUTE_TYPE_DRIVING: ce, BMAP_ROUTE_TYPE_WALKING: be });
    U(window, { BMAP_ROUTE_STATUS_NORMAL: de, BMAP_ROUTE_STATUS_EMPTY: 1, BMAP_ROUTE_STATUS_ADDRESS: 2 });
    var qg = ve.prototype;
    U(qg, { setPolicy: qg.gu });
    var rg = Le.prototype;
    U(rg, { show: rg.show, hide: rg.U, setTypes: rg.QF, setLocation: rg.tn, search: rg.search, setInputValue: rg.Qy });
    U(pb.prototype, {});
    var sg = Ee.prototype;
    U(sg, { get: sg.get });
    U(Yc.prototype, {});
    U(eb.prototype, {});
    U(window, { BMAP_POINT_DENSITY_HIGH: 200, BMAP_POINT_DENSITY_MEDIUM: Rd, BMAP_POINT_DENSITY_LOW: 50 });
    U(window, { BMAP_POINT_SHAPE_STAR: 1, BMAP_POINT_SHAPE_WATERDROP: 2, BMAP_POINT_SHAPE_CIRCLE: td, BMAP_POINT_SHAPE_SQUARE: 4, BMAP_POINT_SHAPE_RHOMBUS: 5 });
    U(window, { BMAP_POINT_SIZE_TINY: 1, BMAP_POINT_SIZE_SMALLER: 2, BMAP_POINT_SIZE_SMALL: 3, BMAP_POINT_SIZE_NORMAL: ud, BMAP_POINT_SIZE_BIG: 5, BMAP_POINT_SIZE_BIGGER: 6, BMAP_POINT_SIZE_HUGE: 7 });
    ...
    U(window, { BMAP_CONTEXT_MENU_ICON_ZOOMIN: ad, BMAP_CONTEXT_MENU_ICON_ZOOMOUT: bd });
    U(window, { BMAP_SYS_DRAWER: Ka, BMAP_SVG_DRAWER: 1, BMAP_VML_DRAWER: 2, BMAP_CANVAS_DRAWER: 3, BMAP_SVG_DRAWER_FIRST: 4 });
    B.Jw();
    B.B0();
})();
