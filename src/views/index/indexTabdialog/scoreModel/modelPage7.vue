    ...
    <div class="scoreModelItem classReadyDialog">
        <div v-if="showDealie">
            <el-row class="diaHeadStandardC" style="background-color: #2b4b6b; padding-left: 12px; color: #fff">
                <el-col :span="18">
                    <div style="height: 46px; line-height: 46px">综合评分 》隐患按时整改率</div>
                </el-col>
                <el-col :span="6">
                    <div class="text_r">
                    ...
                    <el-col :span="6">
                        <div class="third_head_card text_c">
                            <div>
                                <div>未按时整改数</div>
                                <div>
                                    <span>{{ sonData.notHandleOpportunelyRisks }}</span> 个
                                </div>
                            </div>
                        </div>
                    </el-col>
                    <el-col :span="6">
                        <div class="third_head_card text_c">
                            <div>
                                <div>已按时整改数</div>
                                <div>
                                    <span>{{ sonData.handleOpportunelyRisks }}</span> 个
                                </div>
                            </div>
                        </div>
                    </el-col>
        ...
        <div v-else>
            <div class="diaHeadStandardC classReadyDialogTitle">
                <a class="returnbtn" @click="turntopage('alarmanalysis1')"><i class="el-icon-d-arrow-left"></i></a><a class="returnbtn2" @click="closeDialog"><i class="el-icon-circle-close" style="font-size: 26px; color: #5e9ffb; cursor: pointer"></i></a><span>综合评分 》隐患按时整改率</span>
            </div>
